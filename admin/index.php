...
<body>
	...
	<div class="login-page bk-img" style="background-image: url(img/bg5.jpg);">
		<div class="form-content">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3" style="margin-top:4%">
						<h1 class="text-center text-bold text-light mt-4x">Admin Login</h1>
						<div class="well row pt-2x pb-3x" style="background: rgba(255, 255, 255, 0.25); backdrop-filter: blur(10px); border-radius: 10px; box-shadow: 0 8px 20px rgba(0,0,0,0.2);">
						<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn-primary btn-block" value="login" style = "font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif">
								</form>
							</div>
						</div>
					</div>
